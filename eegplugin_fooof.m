function eegplugin_fooof(fig,try_strings,catch_strings)
    ...
    eegfooofplotcommand = [try_strings.no_check 'LASTCOM = pop_eeg_fooofplot(EEG);' catch_strings.store_and_hist];
    % tools menu
    ...
    uimenu(submenu, 'label', 'Plot fit', 'separator','on', 'callback', eegfooofplotcommand);
    % study menu
