function fooof_results = dev_fooof_wrap(cluster, f_range, settings, return_model, plot_model)
    ...
    for c = 1:numel(cluster)
        load(strcat('~/Desktop/IversenLab/fooof_tests/dip_only/brian_diponly_',int2str(c),'_spectra.mat'));
